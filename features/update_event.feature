Feature: Edit an event
    ...
    Background: the website already has some existing events, users and participants
      Given these Events:
            ...
            | Class 1         | October 30, 2018 4:30 PM | Persson 108     | yes       | 3      | Recycling Class                 |
            | Non-recurring 1 | November 2, 2018 7:00 PM | Love Auditorium | no        | 1      |Guest Speaker on Global Warming |
