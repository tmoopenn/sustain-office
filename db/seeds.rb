...
eventA = Event.create!(title:"Living Writers Series", location: "Colgate Memorial Chapel", recurring: true, points: 1, description: "The fall 2017 Living Writers lineup includes three Pulitzer Prize winners of fiction, nonfiction, and poetry. Your level of participation is up to you.") #image: File.open("living_writers.png"))
